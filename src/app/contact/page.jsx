...
export default function ContactPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <Head>
        ...
        <meta
          name="description"
          content="Find the best floral decorations for weddings, home decor, and car decoration.Contact us and order now. Learn where to buy flowers, how much they cost, and how to choose the best floral arrangements."
        />
        <meta
          name="keywords"
          content="flower decorations, wedding flowers, home decor, car decorations, floral arrangements, where to buy flowers, how to decorate with flowers, best flower decorations, flower decoration cost, decoration in indore, flower decoration, indore event decoration"
        />
        <meta name="author" content="Phoolwala" />
        <meta property="og:title" content="Contact Us for Best Flower Decorations for Weddings, Home & Car | Buy Now" />
        <meta
        ...
        <meta property="og:url" content="https://flowers-three-gamma.vercel.app/contact" />
        <link rel="canonical" href="https://flowers-three-gamma.vercel.app/contact" />
  ...
  {`
  {
    ...
    "url": "https://flowers-three-gamma.vercel.app/contact",
